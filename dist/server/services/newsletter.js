...
exports.default = ({ strapi }) => ({
    async subscribe(initialBody) {
        ...
        return await strapi.entityService.create("plugin::strapi-newsletter.subscribed-user", {
            data: {
                email: body.email,
                provider: provider,
            },
    ...
    async getSubscribedUsers() {
        return await strapi.entityService.findMany("plugin::strapi-newsletter.subscribed-user");
    },
    async getAllNewsletter() {
        return await strapi.entityService.findMany("plugin::strapi-newsletter.newsletter");
    },
    async sendNewsletter(body, user) {
        ...
        return await strapi.entityService.create("plugin::strapi-newsletter.newsletter", {
            data: {
